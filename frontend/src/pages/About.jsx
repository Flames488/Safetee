    ...
    <div className="sp">
      ...
      <div className="sp-body">
        ...
        <div className="sp-section">
          ...
          <p>Safetee started from a simple frustration: the moment you actually need a safety app is the moment you're least able to use one normally. So we designed backward from that moment — hidden triggers instead of buried menus, automatic SMS fallback instead of assuming perfect signal, and a trusted-contacts system that notifies people in the order that actually helps.</p>
        </div>
